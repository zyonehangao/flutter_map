...
// Minimum logical pixel size of the IconButtons.
...
class IconButtons extends StatelessWidget {
  ...
  /// [Icon.size] property allows the [IconButtons] to size the splash area to
  /// fit the [Icon]. If you were to set the size of the [Icon] using
  /// [Icon.size] instead, then the [IconButtons] would default to 24.0 and then
  ...
  /// Defines how the icon is positioned within the IconButtons.
  ///
